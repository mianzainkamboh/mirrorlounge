    ...
    <div className="p-2 sm:p-3">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-3 sm:mb-4">
          <h1 className="text-base sm:text-lg font-medium text-pink-600 mb-1">Dashboard</h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 mb-3 sm:mb-4">
          {stats.map((stat) => (
            <div key={stat.name} className="bg-white/90 backdrop-blur-xl border border-pink-200/30 rounded-xl sm:rounded-2xl p-2 sm:p-3 shadow-[0_8px_30px_rgb(233,30,99,0.15)] transition-all duration-300 hover:shadow-[0_12px_40px_rgb(233,30,99,0.25)]">
              <div className="flex items-center justify-between mb-1 sm:mb-2">
                <div className={`w-4 h-4 sm:w-6 sm:h-6 rounded-lg bg-${stat.color}-500/10 flex items-center justify-center`}>
                  <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 bg-${stat.color}-500 rounded-full`}></div>
                </div>
                <div className="text-xs text-pink-500 font-medium hidden sm:block">{stat.change}</div>
              </div>
              <div className="text-xs font-medium text-pink-600 mb-1">{stat.name}</div>
              <div className="text-base sm:text-lg font-semibold text-pink-700">{stat.value}</div>
              <div className="text-xs text-pink-500 font-medium sm:hidden mt-1">{stat.change}</div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
          ...
          <div>
            <div className="bg-white/90 backdrop-blur-xl border border-pink-200/30 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-[0_8px_30px_rgb(233,30,99,0.15)] transition-all duration-300 hover:shadow-[0_12px_40px_rgb(233,30,99,0.25)]">
              <h2 className="text-sm font-semibold text-pink-700 mb-2 sm:mb-3">Recent Activity</h2>
              <div className="space-y-1.5 sm:space-y-2">
                {recentActivity.length > 0 ? (
                  recentActivity.map((activity, index) => (
                    <div key={index} className="flex items-start space-x-2 sm:space-x-3 p-1.5 sm:p-2 rounded-lg hover:bg-pink-50/50 transition-all duration-200">
                      <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-pink-400 rounded-full mt-1 sm:mt-1.5 flex-shrink-0"></div>
        ...
        <div className="mt-3 sm:mt-4">
          <div className="bg-white/90 backdrop-blur-xl border border-pink-200/30 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-[0_8px_30px_rgb(233,30,99,0.15)] transition-all duration-300 hover:shadow-[0_12px_40px_rgb(233,30,99,0.25)]">
            <h2 className="text-sm font-semibold text-pink-700 mb-2 sm:mb-3">Quick Actions</h2>
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2">
              {quickActions.map((action) => (
                ...
                >
                  <div className="w-5 h-5 sm:w-6 sm:h-6 bg-white rounded-md mr-2 sm:mr-3 flex items-center justify-center group-hover:bg-pink-50 transition-all duration-200 shadow-sm">
