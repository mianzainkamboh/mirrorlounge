      ...
      <div className="p-3">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-center py-12">
            ...
            <span className="ml-3 text-pink-600">Loading categories...</span>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-lg font-medium text-pink-600 mb-1">Categories</h1>
        ...
        {categories.filter(cat => cat.gender === 'men').length > 0 && (
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-blue-600 mb-4">Men Categories</h2>
        ...
        {categories.filter(cat => cat.gender === 'women').length > 0 && (
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-pink-600 mb-4">Women Categories</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        {categories.filter(cat => cat.gender === 'unisex').length > 0 && (
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-purple-600 mb-4">Unisex Categories</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        {categories.length === 0 && !loading && (
          <div className="text-center py-6">
            <div className="w-10 h-10 bg-gradient-to-br from-pink-200 to-pink-300 rounded-xl flex items-center justify-center mx-auto mb-2">
              <div className="text-sm text-pink-600">📂</div>
            </div>
    ...
    <div className="bg-white/90 backdrop-blur-xl border border-pink-200/30 rounded-2xl overflow-hidden shadow-[0_8px_30px_rgb(233,30,99,0.15)] transition-all duration-300 hover:shadow-[0_12px_40px_rgb(233,30,99,0.25)] hover:scale-[1.02] group">
      ...
      <div className="relative h-24 overflow-hidden">
        ...
        <div className="absolute top-2 left-2">
          <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${getGenderBadgeColor(category.gender)} backdrop-blur-sm`}>
      ...
      <div className="p-3">
        ...
        <p className="text-xs text-pink-600 leading-tight mb-2 line-clamp-2">{category.description}</p>
