    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-pink-100 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-40 right-20 w-1 h-1 bg-pink-400/40 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
          <div className="absolute bottom-40 left-20 w-1.5 h-1.5 bg-pink-200/50 rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
          <div className="absolute bottom-20 right-10 w-1 h-1 bg-pink-300/40 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
          <div className="absolute top-1/2 left-1/3 w-1 h-1 bg-pink-400/30 rounded-full animate-pulse" style={{ animationDelay: '2.5s' }} />
          <div className="absolute bottom-1/2 right-1/3 w-1.5 h-1.5 bg-pink-300/25 rounded-full animate-pulse" style={{ animationDelay: '1.8s' }} />
        </div>
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
            {[...Array(4)].map((_, index) => (
              <div 
                key={index}
                className="bg-gradient-to-br from-white/95 via-pink-50/80 to-white/90 backdrop-blur-xl border border-pink-200/40 rounded-2xl sm:rounded-3xl p-3 sm:p-4 shadow-[0_8px_32px_rgba(233,30,99,0.12)] animate-pulse"
                style={{ animationDelay: `${index * 200}ms` }}
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-pink-200/60 to-pink-300/40 rounded-xl sm:rounded-2xl" />
          ...
          <div className="bg-gradient-to-br from-white/95 via-pink-50/80 to-white/90 backdrop-blur-xl border border-pink-200/40 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-[0_8px_32px_rgba(233,30,99,0.12)] mb-6">
            <div className="flex items-center justify-between mb-6">
              <div className="h-6 bg-gradient-to-r from-pink-200/60 to-pink-100/40 rounded-lg w-32" />
          ...
          <div className="bg-gradient-to-br from-white/95 via-pink-50/80 to-white/90 backdrop-blur-xl border border-pink-200/40 rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-[0_8px_32px_rgba(233,30,99,0.12)]">
            <div className="flex items-center justify-between mb-6">
          ...
          <div className="fixed inset-0 flex items-center justify-center pointer-events-none">
            <div className="text-center">
              <div className="relative">
                <div className="w-20 h-20 border-4 border-pink-200/50 rounded-full animate-spin" />
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-pink-100 relative overflow-hidden">
      ...
      <div className="relative z-10 p-2 sm:p-3">
        ...
        <div className="mb-4 sm:mb-6 px-2 sm:px-0">
          ...
          <p className="text-pink-600 text-sm sm:text-base lg:text-lg font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
          ...
          <div>
            <div className="bg-white/90 backdrop-blur-xl border border-pink-200/30 rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-[0_8px_30px_rgb(233,30,99,0.15)] transition-all duration-300 hover:shadow-[0_12px_40px_rgb(233,30,99,0.25)]">
          ...
          <div>
            <div className="bg-gradient-to-br from-white/95 via-pink-50/80 to-white/90 backdrop-blur-xl border border-pink-200/40 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-[0_8px_32px_rgba(233,30,99,0.12)] mx-2 sm:mx-0">
              <div className="flex items-center justify-between mb-4 sm:mb-6">
                <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-pink-700 to-pink-600 bg-clip-text text-transparent">Recent Activity</h2>
                <div className="flex items-center space-x-2">
              ...
              <div className="relative">
                {/* Timeline line */}
                <div className="absolute left-4 lg:left-6 top-0 bottom-0 w-0.5 lg:w-1 bg-gradient-to-b from-pink-300 via-pink-400 to-pink-300 rounded-full" />
                ...
                <div className="space-y-6 lg:space-y-8">
                  {recentActivity.length > 0 ? (
                    recentActivity.map((activity, index) => (
                      <div 
                        key={index} 
                        className="group relative flex items-start space-x-4 lg:space-x-6 p-4 lg:p-6 rounded-xl lg:rounded-2xl bg-gradient-to-r from-white/60 to-pink-50/40 hover:from-white/80 hover:to-pink-50/60 border border-pink-200/30 hover:border-pink-300/50 transition-all duration-300 hover:shadow-[0_4px_20px_rgba(233,30,99,0.15)] hover:scale-[1.01] active:scale-[0.99] touch-manipulation"
                        style={{ animationDelay: `${index * 150}ms` }}
                      >
                        {/* Timeline dot */}
                        <div className="relative z-10 flex-shrink-0">
                          <div className="w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-br from-pink-500 to-pink-600 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                            <div className="w-3 h-3 lg:w-4 lg:h-4 bg-white rounded-full" />
                            <div className="absolute -inset-1 bg-pink-400/30 rounded-full blur opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                          </div>
                          {/* Connecting line to timeline */}
                          <div className="absolute top-4 lg:top-5 -left-4 lg:-left-6 w-4 lg:w-6 h-0.5 lg:h-1 bg-gradient-to-r from-pink-400 to-pink-300" />
                        </div>
                        
                        {/* Activity content */}
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between mb-1">
                            <p className="text-sm sm:text-base lg:text-lg text-pink-700 font-semibold group-hover:text-pink-800 transition-colors duration-200">
                              {activity.action}: <span className="text-pink-600">{activity.item}</span>
                            </p>
                            <div className="flex items-center space-x-1 ml-2">
                              <div className="w-1 h-1 bg-pink-400/60 rounded-full" />
                              <div className="w-1 h-1 bg-pink-300/60 rounded-full" />
                            </div>
                          </div>
